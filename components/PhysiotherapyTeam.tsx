...
const teamMembers = [
    ...
    },
    {
        ...
        bio: "Dr. Vaishali Vijay Rauniyar brings clinical experience across sports, orthopaedic, and neurological rehabilitation. Her dual certification in Dry Needling and Aquatic Rehabilitation gives patients access to treatment approaches most physiotherapy clinics in Mumbai do not offer. Her neurological rehabilitation background makes her particularly well-suited for complex cases requiring multi-system assessment — stroke recovery, Parkinson's, and peripheral nerve injury."
    },
];
