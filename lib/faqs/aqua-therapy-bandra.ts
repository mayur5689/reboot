export const aquaTherapyBandraFaqs = [
  {
  ...
  },
  {
    ...
    answer:
      'By train: Bandra station to Dadar on the Western Line takes approximately 8 minutes. R3BOOT is then a short auto ride or 10-15 minute walk from Dadar station. By road: Bandra to Dadar East is 15-20 minutes depending on traffic, with direct routes via Western Express Highway or LJ Road.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Session count depends on your condition, not your travel distance. Post-surgical rehabilitation typically requires 8 to 12 sessions over 6 to 8 weeks. Sports injuries typically 4 to 8 sessions. Your physiotherapist will give you a session estimate after the initial assessment. Many Bandra patients batch their aqua therapy with sports massage or physiotherapy in one trip to make the journey efficient.',
  },
]
