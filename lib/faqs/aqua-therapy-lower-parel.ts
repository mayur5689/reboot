export const aquaTherapyLowerParelFaqs = [
  {
  ...
  },
  {
    ...
    answer:
      'Yes. Lower Parel has a high concentration of fitness facilities and one of Mumbai\'s busiest corporate gym populations. Common injuries in this group - lower back pain from deadlifts, knee overuse from running and squatting, shoulder impingement from pressing - all respond well to aqua therapy in the sub-acute and chronic phases. Water allows therapeutic movement and strengthening without the impact and joint load that aggravates these conditions on land.',
  },
  {
    question: 'Can I get aqua therapy before or after work if I am based in Lower Parel?',
    answer:
      'R3BOOT runs sessions Monday to Saturday with structured appointment slots that work around professional schedules. Lower Parel to Dadar is 5-10 minutes, which makes pre-work, lunch-break, and post-work sessions viable. Sunday hours run from 2:00 PM to 9:00 PM. Call +91 97023 68612 to check current availability.',
  },
  {
