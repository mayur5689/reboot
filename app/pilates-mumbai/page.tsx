...
import { pilatesMumbaiFaqs } from '@/lib/faqs/pilates-mumbai'
...
export const metadata: Metadata = {
  title: 'Pilates Mumbai | Physio-Led Reformer & Mat | R3BOOT Dadar',
  description:
    'Pilates in Mumbai at R3BOOT Dadar | physiotherapist-led, 1:1 reformer & mat. For beginners, desk posture, back pain & athletes. Not a group fitness class. Book via WhatsApp.',
  alternates: { canonical: '/pilates-mumbai' },
  keywords: [
    'pilates mumbai',
    'pilates in mumbai',
    'pilates class mumbai',
    'pilates studio mumbai',
    'pilates classes mumbai',
    'best pilates in mumbai',
    'reformer pilates mumbai',
    'pilates for beginners mumbai',
    'pilates dadar',
...
const commercialPainPoints = [
  ...
  },
  {
    ...
    description: 'You searched Pilates in Mumbai but do not want to be dropped into an advanced class. Assessment-first sessions match your level.',
  ...
  },
  {
    ...
    description: 'Celebrity studios and academies are everywhere. You are looking for private, physiotherapist-led Pilates with clear next steps.',
  ...
  },
  {
    ...
    description: 'Reformer looks great until you share it with ten people. At R3BOOT, springs are set for you in a one-to-one session.',
...
const clusterLinks = [
  { label: 'Pilates Lower Parel', href: '/pilates-lower-parel', eyebrow: 'Lower Parel studio' },
  { label: 'Reformer Pilates Mumbai', href: '/reformer-pilates-mumbai', eyebrow: 'Equipment' },
  { label: 'Reformer Pilates Lower Parel', href: '/reformer-pilates-lower-parel', eyebrow: 'Equipment · LP' },
...
export default function PilatesMumbaiPage() {
  return (
    <main className="min-h-screen bg-white dark:bg-[#0A0A0A]">
      ...
      <section className="hidden md:flex flex-col bg-black overflow-hidden pt-20 lg:pt-24" style={{ minHeight: '92vh' }}>
        <div className="relative flex flex-1 flex-col">
          <div className="absolute inset-0">
            <Image
              src="https://res.cloudinary.com/dj7bot2uc/image/upload/v1785290132/hero_image_lxzfvf.png"
              alt="Pilates Mumbai, R3BOOT Dadar reformer studio"
              fill
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-center px-12 lg:px-16 xl:px-20 max-w-[54%]">
            ...
            <p className="text-[16px] text-white/55 max-w-md leading-relaxed mb-7">
              One-to-one Pilates for beginners, desk posture, back pain, and athletes. Assessment first. Not a packed group fitness class.
            </p>
      ...
      <section className="md:hidden pt-20 pb-0 bg-white dark:bg-[#0A0A0A]">
        <div className="container mx-auto px-5">
          ...
          <h1 className="text-[2rem] font-black text-gray-900 dark:text-white tracking-tight leading-[1.1] mb-3">
            Pilates in <span className="text-[#513394] dark:text-[#A78BFA]">Mumbai</span>
          </h1>
          <p className="text-base text-gray-500 dark:text-gray-400 leading-relaxed mb-6">
            One-to-one, physiotherapist-led Pilates at R3BOOT Dadar. Reformer and mat. Assessment first — not a packed group class.
          </p>
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight mb-4 leading-tight">
              How We Deliver <span className="text-[#513394] dark:text-[#8B5CF6]">Pilates at R3BOOT</span>
            </h2>
            <p className="text-gray-500 dark:text-gray-400 text-base leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24 items-start max-w-7xl mx-auto">
            <div className="relative rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden aspect-[4/5] w-full shadow-2xl lg:sticky lg:top-28">
              <Image
                src="https://res.cloudinary.com/dj7bot2uc/image/upload/v1790348802/PILATES_IMAGE__vsjd1a.png"
                ...
                {[
                  {
                    ...
                    body: 'Spring resistance for precise loading. Ideal for beginners who need support, early rehab, and athletes who need controlled strength. See our dedicated Reformer Pilates Mumbai page.',
                    light: '#513394',
                    dark: '#A78BFA',
      ...
      <ComparisonSection
        ...
        subtitle="A group class follows a fixed sequence for everyone in the room. At R3BOOT, Pilates starts with your assessment and progresses one-to-one with a physiotherapist."
        leftColumnLabel="Group Pilates Studio"
        rightColumnLabel="R3BOOT Pilates"
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-gray-900 dark:text-white tracking-tight">
              Built for Your <span className="text-[#513394] dark:text-[#8B5CF6]">Goals in Mumbai</span>
            </h2>
          </div>
            ...
            {[
              {
                ...
                image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1790348110/BEGINNER___Beginners_Starting_Pilates_rurxfz.webp',
              ...
              },
              {
                ...
                image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1790348111/DESK___Desk_Posture_Back_Pain_au57lr.webp',
              ...
              },
              {
                ...
                image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1790348111/RETURN___Returning_After_Time_Off_odqaup.webp',
                points: ['Gym & HYROX', 'Running control', 'Recovery support'],
              },
              {
                label: 'Returning After Time Off',
                tag: 'RETURN //',
                description: 'Easing back onto reformer or mat after a break. For dedicated injury or post-surgery pathways, we hand you to our Clinical Pilates programs.',
                image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1790348112/SPORT___Gym_Sport_Recovery_sptc8j.webp',
      ...
      <FAQSection faqs={pilatesMumbaiFaqs} layout="grid" />
          ...
          >
            ...
            <div className="relative">
              <h2 className="text-[26px] font-black text-white leading-tight tracking-tight mb-2">
                Book Pilates in <span className="text-[#A78BFA]">Mumbai</span>
              </h2>
              <p className="text-white/55 text-[13px] leading-relaxed mb-5">
                Assessment first. One-to-one. Physio-led reformer and mat at R3BOOT Dadar.
              </p>
      ...
      <section className="hidden md:block py-16 lg:py-20 bg-[#513394] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10 text-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tight mb-5 max-w-3xl mx-auto leading-tight">
            Book Pilates in <span className="text-white/45">Mumbai</span>
          </h2>
          <p className="text-lg text-white/65 mb-10 max-w-xl mx-auto leading-relaxed">
            R3BOOT Dadar East. One-to-one, physiotherapist-led. Your first session includes a full assessment.
          </p>
      ...
      <ServiceSchema
        serviceName="Pilates in Mumbai"
        description="Physiotherapist-led Pilates in Mumbai at R3BOOT Dadar. One-to-one reformer and mat sessions for beginners, desk posture, and athletes. Assessment-first, not a group fitness class."
        serviceUrl="https://www.r3boot.in/pilates-mumbai"
      />
      <FAQSchema faqs={pilatesMumbaiFaqs} />
      <BreadcrumbSchema
        items={[
          { name: 'Home', url: '/' },
