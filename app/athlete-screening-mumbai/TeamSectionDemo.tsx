...
const members: TeamMember[] = [
  {
    ...
    description:
      'Every screening is run and read by a qualified physiotherapist. Your history, your exam, and your risk report are all in the same expert hands.',
      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="mb-10 lg:mb-14 text-center">
          ...
          <h2 className="text-4xl lg:text-5xl font-extrabold text-white leading-tight tracking-tight">
            The team behind{' '}
            <span className="text-[#A78BFA]">your screening.</span>
          </h2>
    ...
    <section className="md:hidden py-12 bg-[#0D0D0D]">
      <div className="px-5">
        ...
        <h2 className="text-[28px] font-extrabold text-white leading-tight tracking-tight mb-2">
          The team behind<br />
          your <span className="text-[#A78BFA]">screening.</span>
        </h2>
