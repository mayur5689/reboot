...
import { Dumbbell, Crosshair, Target, ClipboardCheck, TrendingUp, UserCheck, Trophy, Check } from 'lucide-react'

const ROWS = [
  {
    icon: Target,
    label: 'What it measures',
    generic: 'Strength, speed, endurance in isolation',
    screening: 'Mobility, stability, gait, and strength together',
  },
  {
    icon: Crosshair,
    label: 'Injury risk',
    generic: 'Not assessed',
    screening: 'Full MSK exam plus a special-test battery scored by risk',
  },
  {
    icon: Dumbbell,
    label: 'Sport-specificity',
    generic: 'Same drills for every client',
    screening: 'Tests chosen for your sport, position, and demands',
  },
  {
    icon: TrendingUp,
    label: 'Baseline tracking',
    generic: 'A one-off number, no context',
    screening: 'A benchmark you re-test and compare over time',
  },
  {
    icon: ClipboardCheck,
    label: 'What you leave with',
    generic: 'A printout of scores',
    screening: 'A clinician summary and a Recovery & Performance Plan',
  },
  {
    icon: UserCheck,
    label: 'Who runs it',
    generic: 'Trainer or an app',
    screening: 'Physiotherapist-led clinical team',
  },
  {
    icon: Trophy,
    label: 'Best for',
    generic: 'General fitness tracking',
    screening: 'Athletes managing training load and injury risk',
  },
]
      ...
      <div className="container mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight leading-[1.1] mb-5">
            Athlete Screening goes further than a{' '}
            <span className="text-[#7B5FCA]">fitness test.</span>
          </h2>
          <div className="w-10 h-[2px] bg-[#7B5FCA] mx-auto mb-5" />
          <p className="text-white/45 text-base leading-relaxed">
            A fitness test tells you your numbers today. A screening tells you why, and what those numbers are about to cost you if nothing changes.
          </p>
        </div>
              ...
              <div key={i} className="rounded-2xl border border-white/[0.08] bg-[#0D0D13] overflow-hidden">
                ...
                <div className="px-5 py-4 border-b border-white/[0.06]">
                  <div className="flex items-center gap-2 mb-1.5">
                    ...
                    <span className="text-white/35 text-[10px] font-black tracking-widest uppercase">Fitness Test</span>
                  </div>
                ...
                <div className="px-5 py-4" style={{ background: 'rgba(123,95,202,0.08)' }}>
                  <div className="flex items-center justify-between mb-1.5">
                    <div className="flex items-center gap-2">
                      <Crosshair className="w-3.5 h-3.5 text-[#A78BFA]" />
          ...
          <div className="grid" style={{ gridTemplateColumns: COLS }}>
            ...
            <div style={{ gridColumn: 2, gridRow: HEADER_ROW }} className="flex items-center justify-center gap-3 h-full px-3 sm:px-7 py-6 sm:py-7">
              <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full border-[1.5px] border-white/30 bg-white/[0.06] flex items-center justify-center shrink-0">
                <Dumbbell className="w-[18px] h-[18px] text-white/60" />
              </div>
            ...
            <div style={{ gridColumn: 3, gridRow: HEADER_ROW }} className="relative flex items-center justify-center gap-3 h-full px-4 sm:px-7 py-6 sm:py-7">
              <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full border-[1.5px] border-[#A78BFA] bg-[rgba(167,139,250,0.10)] flex items-center justify-center shrink-0">
                <Crosshair className="w-[18px] h-[18px] text-[#A78BFA]" />
              </div>
              <span className="text-white font-black text-[13px] sm:text-[15px] tracking-wide uppercase whitespace-nowrap">
                Athlete Screening
              </span>
