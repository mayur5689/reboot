              ...
              <div key={i} className="rounded-2xl border border-gray-100 dark:border-white/[0.08] bg-white dark:bg-[#0D0D13] overflow-hidden">
                ...
                <div className="px-5 py-4 border-b border-gray-100 dark:border-white/[0.06]">
                  <div className="flex items-center gap-2 mb-1.5">
                    <Snowflake className="w-3.5 h-3.5 text-gray-400 dark:text-[#7DD8F8]" />
                    <span className="text-gray-400 dark:text-white/35 text-[10px] font-black tracking-widest uppercase">Ice Bath Only</span>
                  </div>
                  <p className="text-gray-500 dark:text-white/45 text-[14px] leading-snug pl-[22px]">{row.iceBath}</p>
                </div>

                <div className="px-5 py-4 bg-[#513394]/[0.05] dark:bg-[rgba(123,95,202,0.08)]">
                  <div className="flex items-center justify-between mb-1.5">
                    <div className="flex items-center gap-2">
                      <ContrastIcon className="w-3.5 h-3.5 text-[#513394] dark:text-[#A78BFA]" />
                      <span className="text-[#513394] dark:text-[#A78BFA] text-[10px] font-black tracking-widest uppercase">Contrast Therapy</span>
                    </div>
                    <div className="w-5 h-5 rounded-full bg-[#7B5FCA] flex items-center justify-center shrink-0">
                      <Check className="w-3 h-3 text-white" strokeWidth={3} />
                    </div>
                  </div>
                  <p className="text-[#513394] dark:text-[#C4B5FD] font-bold text-[14px] leading-snug pl-[22px]">{row.contrast}</p>
                </div>
              </div>
            )
          })}
