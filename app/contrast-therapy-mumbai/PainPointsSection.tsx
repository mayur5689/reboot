...
const POINTS = [
  {
    ...
    image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1782585135/Image_1_ukvuob.webp',
  },
  {
    ...
    image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1782585135/image_2_nzwsyf.webp',
  },
  {
    title: 'Performance drops mid-week',
    description: 'Strong on Monday, dead by Wednesday. Recovery is the missing variable.',
    image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1782585135/image_3_qwrebq.webp',
  },
  {
    title: 'Tight muscles stretching cannot fix',
    description: 'Foam rolling helps briefly. The tension returns within hours.',
    image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1782585136/image_4_odsyro.webp',
  },
  {
    ...
    image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1782585136/image_5_u2avjm.webp',
  },
  {
    ...
    image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1782585736/image_6_1_ht90ck.webp',
  },
]
...
export function PainPointsSection() {
  ...
  return (
    <section id="services" className="bg-[#F8F9FA] dark:bg-[#080808] py-16 sm:py-20 lg:py-24">
      ...
      <div className="text-center mb-10 sm:mb-12 px-5">
        ...
        <p className="text-gray-500 dark:text-white/40 text-base sm:text-lg mt-4 max-w-2xl mx-auto leading-relaxed">
          If any of these feel like your week, recovery is the variable you&apos;re missing.
        </p>
      </div>
            ...
            <div className="relative rounded-2xl overflow-hidden min-h-[560px] xl:min-h-[600px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 z-10 p-8">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-white font-bold text-[13px] leading-snug">Recovery isn&apos;t a luxury.</p>
                    <p className="text-white/40 text-[13px]">It&apos;s what keeps you consistent.</p>
                  </div>
                </div>
              </div>
            </div>
