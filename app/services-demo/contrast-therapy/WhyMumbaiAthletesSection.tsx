        ...
        <div className="grid grid-cols-1 lg:grid-cols-[42%_1fr] gap-10 lg:gap-16 items-start">
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-black text-white tracking-tight leading-[1.1] mb-5">
              ...
              Choose <span className="text-[#7B5FCA]">Contrast Therapy</span>
            </h2>
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-white/50 text-[15px] leading-relaxed pt-1.5">
                ...
                <Link href="/services/sports-massage" className="text-[#C4B5FD] font-bold hover:underline underline-offset-4">sports massage</Link>,{' '}
                <Link href="/services/physiotherapy" className="text-[#C4B5FD] font-bold hover:underline underline-offset-4">physiotherapy</Link> and{' '}
                <Link href="/services/sports-psychology" className="text-[#C4B5FD] font-bold hover:underline underline-offset-4">sports psychology</Link> for complete, stage-wise recovery.
              </p>
            </div>
          </div>
