          ...
          <div>
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-white/50 text-[15px] leading-relaxed pt-1.5">
                ...
                <Link href="/services/mental-training" className="text-[#C4B5FD] font-bold hover:underline underline-offset-4">sports psychology</Link> for complete, stage-wise recovery.
              </p>
            </div>
          </div>
