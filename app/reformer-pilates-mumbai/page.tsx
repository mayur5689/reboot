...
import { reformerPilatesMumbaiFaqs } from '@/lib/faqs/reformer-pilates-mumbai'
...
import { LocationSection } from '@/app/services/clinical-pilates/LocationSection'
...
export const metadata: Metadata = {
  title: 'Reformer Pilates Mumbai | Physio-Led 1:1 | R3BOOT Dadar',
  description:
    'Reformer Pilates in Mumbai at R3BOOT Dadar | physiotherapist-led, one-to-one. Spring-loaded rehab & strength for beginners, back pain & athletes. Book via WhatsApp.',
  alternates: { canonical: '/reformer-pilates-mumbai' },
  keywords: [
    'reformer pilates mumbai',
    'reformer pilates near me mumbai',
    'pilates reformer mumbai',
    'reformer pilates dadar',
    'reformer pilates for beginners mumbai',
    'pilates reformer class mumbai',
    'physiotherapist reformer pilates mumbai',
    'private reformer pilates mumbai',
  ],
}
...
const heroSlides = [
  ...
  },
  {
    ...
    alt: 'R3BOOT Pilates studio, reformer machines at Dadar, Mumbai',
  },
  {
...
const reformerPainPoints = [
  ...
  {
    title: 'Comparing reformer studios in Mumbai',
    description: 'Fitness reformer brands sell energy and timetables. You are comparing private, physiotherapist-led options.',
...
const clusterLinks = [
  { label: 'Pilates Mumbai', href: '/pilates-mumbai', eyebrow: 'City head page' },
  { label: 'Reformer Pilates Lower Parel', href: '/reformer-pilates-lower-parel', eyebrow: 'Lower Parel studio' },
  { label: 'Clinical Pilates Mumbai', href: '/clinical-pilates-mumbai', eyebrow: 'Injury programs' },
  { label: 'Pilates for Back Pain', href: '/back-pain-clinical-pilates-mumbai', eyebrow: 'Condition' },
  { label: 'Post-Surgery Pilates', href: '/post-surgery-pilates-mumbai', eyebrow: 'Rehab handoff' },
  { label: 'Physiotherapy Dadar', href: '/physiotherapy-dadar-mumbai', eyebrow: 'Related care' },
]
...
export default function ReformerPilatesMumbaiPage() {
  return (
    <main className="min-h-screen bg-white dark:bg-[#0A0A0A]">
      ...
      <section className="hidden md:flex flex-col bg-black overflow-hidden pt-20 lg:pt-24" style={{ minHeight: '92vh' }}>
        <div className="relative flex flex-1 flex-col">
          <div className="absolute inset-0">
            <Image
              src="https://res.cloudinary.com/dj7bot2uc/image/upload/v1785290132/hero_image_lxzfvf.png"
              alt="Reformer Pilates Mumbai, R3BOOT Dadar studio"
              fill
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-center px-12 lg:px-16 xl:px-20 max-w-[54%]">
            <p className="text-[#A78BFA] text-[11px] font-black tracking-[0.25em] uppercase mb-4">
              Physiotherapist-Led&nbsp;&nbsp;•&nbsp;&nbsp;1:1&nbsp;&nbsp;•&nbsp;&nbsp;Spring-Loaded
            </p>
            ...
            <p className="text-[16px] text-white/55 max-w-md leading-relaxed mb-7">
              One-to-one reformer sessions with spring-loaded control. Assessment first. Built for beginners, back pain, rehab, and athletes.
            </p>
      ...
      <section className="md:hidden pt-20 pb-0 bg-white dark:bg-[#0A0A0A]">
        <div className="container mx-auto px-5">
          ...
          <h1 className="text-[2rem] font-black text-gray-900 dark:text-white tracking-tight leading-[1.1] mb-3">
            Reformer Pilates in <span className="text-[#513394] dark:text-[#A78BFA]">Mumbai</span>
          </h1>
          <p className="text-base text-gray-500 dark:text-gray-400 leading-relaxed mb-6">
            One-to-one, physiotherapist-led reformer at R3BOOT Dadar. Spring-loaded control for beginners, rehab, and athletes — not a group reformer class.
          </p>
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight mb-4">
              What to expect on the <span className="text-[#513394] dark:text-[#8B5CF6]">Reformer</span>
            </h2>
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight mb-4 leading-tight">
              How We Deliver <span className="text-[#513394] dark:text-[#8B5CF6]">Reformer Pilates</span>
            </h2>
            <p className="text-gray-500 dark:text-gray-400 text-base leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24 items-start max-w-7xl mx-auto">
            <div className="relative rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden aspect-[4/5] w-full shadow-2xl lg:sticky lg:top-28">
              <Image
                src="https://res.cloudinary.com/dj7bot2uc/image/upload/v1777793759/Clinical_Pillates_Image_4_rluyr1.png"
                alt="Reformer Pilates Mumbai – R3BOOT physiotherapist-led"
                fill
                className="object-cover"
              />
      ...
      <ComparisonSection
        ...
        subtitle="A group reformer class follows a fixed sequence for the room. At R3BOOT, springs are set for you in a one-to-one session with a physiotherapist."
        leftColumnLabel="Group Reformer Studio"
        rightColumnLabel="R3BOOT Reformer"
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-gray-900 dark:text-white tracking-tight">
              Who Books <span className="text-[#513394] dark:text-[#8B5CF6]">Reformer at R3BOOT</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6">
            {[
              ...
              },
              {
                ...
                tag: 'RETURN //',
                description: 'Springs that go up or down in small steps when you are returning to movement. Injury-specific pathways live on our Clinical Pilates pages.',
      ...
      <FAQSection faqs={reformerPilatesMumbaiFaqs} layout="grid" />
          ...
          >
            <div className="relative">
              <h2 className="text-[26px] font-black text-white leading-tight tracking-tight mb-2">
                Book Reformer <span className="text-[#A78BFA]">Pilates</span>
              </h2>
              <p className="text-white/55 text-[13px] leading-relaxed mb-5">
                Assessment first. One-to-one. Physio-led reformer at R3BOOT Dadar.
              </p>
      ...
      <section className="hidden md:block py-16 lg:py-20 bg-[#513394] relative overflow-hidden">
        <div className="container mx-auto px-6 lg:px-8 relative z-10 text-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tight mb-5 max-w-3xl mx-auto leading-tight">
            Book Reformer Pilates in <span className="text-white/45">Mumbai</span>
          </h2>
          <p className="text-lg text-white/65 mb-10 max-w-xl mx-auto leading-relaxed">
            R3BOOT Dadar East. One-to-one, physiotherapist-led reformer. First session includes a full assessment.
          </p>
      ...
      <ServiceSchema
        serviceName="Reformer Pilates in Mumbai"
        description="Physiotherapist-led reformer Pilates in Mumbai at R3BOOT Dadar. One-to-one spring-loaded sessions for beginners, desk posture, and athletes. Assessment-first, not a group reformer class."
        serviceUrl="https://www.r3boot.in/reformer-pilates-mumbai"
      />
      <FAQSchema faqs={reformerPilatesMumbaiFaqs} />
      <BreadcrumbSchema
        items={[
          { name: 'Home', url: '/' },
          { name: 'Pilates Mumbai', url: '/pilates-mumbai' },
