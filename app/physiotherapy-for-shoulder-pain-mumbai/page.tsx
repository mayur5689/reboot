...
import { shoulderPainPhysiotherapyFaqs } from '@/lib/faqs/physiotherapy-shoulder-pain-mumbai'
...
import { LocationSection } from '@/app/services/physiotherapy/LocationSection'
import {
  ClipboardCheck,
  Hand,
  Target,
...
export const metadata: Metadata = {
  title: 'Physiotherapy for Shoulder Pain Mumbai | Frozen Shoulder & Cuff | R3BOOT',
  description:
    'Clinical physiotherapy for shoulder pain in Mumbai at R3BOOT Dadar. Frozen shoulder, rotator cuff, impingement, gym & desk overload. Dry needling available. 5.0 ★ Google. WhatsApp to book.',
  alternates: { canonical: '/physiotherapy-for-shoulder-pain-mumbai' },
  keywords: [
    'physiotherapy for shoulder pain mumbai',
    'shoulder pain physiotherapy mumbai',
    'frozen shoulder physiotherapy mumbai',
    'rotator cuff physiotherapy mumbai',
    'shoulder impingement physiotherapy mumbai',
    'physiotherapy for shoulder pain dadar',
    'shoulder pain clinic dadar',
    'shoulder pain physiotherapy near me',
    'frozen shoulder treatment mumbai',
    'shoulder pain after gym physiotherapy',
  ],
}
...
const heroSlides = [
  {
    ...
    alt: 'Physiotherapy for shoulder pain at R3BOOT Dadar, Mumbai',
  },
  {
    src: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1771760500/Physiotherepy_Image_jz7ubj.webp',
    alt: 'Manual therapy for shoulder pain at R3BOOT Mumbai',
  },
  {
    src: '/images/hero/r3boot-physiotherapy.png',
    alt: 'Clinical shoulder physiotherapy care at R3BOOT',
  },
]
...
const testimonials = [
  {
    ...
    quote:
      'Dry needling sessions combined with exercises changed my shoulder problem completely. Dr. Vaishali is incredibly knowledgeable and caring.',
  },
  {
    ...
    quote:
      'Dr. Hiral fixed my back pain after 2 years of trying other clinics. The assessment was thorough and the treatment actually addresses root causes, not just symptoms. Highly recommend.',
  },
  {
    ...
    avatar: '/images/Customer_Review/Sonal Malik.png',
    quote:
      'My knee pain from running disappeared within 6 sessions. They gave me a clear plan and explained exactly what was wrong. Professional and results-driven.',
  },
  {
    name: 'Namrata Doshi',
    ...
    avatar: '/images/Customer_Review/Namrata Doshi.png',
    quote:
      'After my ACL surgery, their rehab protocol was exactly what I needed. Structured, progressive, and they coordinated with my surgeon. Back to playing cricket in 4 months.',
  },
  {
    ...
    quote:
      'Best physio clinic in Dadar. They treat the problem, not just the pain. Long-term results, not quick fixes.',
  },
  {
    name: 'Arjun',
    ...
    quote:
      'Fantastic experience. The team is professional, the facility is clean, and the results speak for themselves. Worth every rupee.',
  },
]

const shoulderPainCauses = [
  {
    title: 'Rotator cuff overload',
    body: 'Pain with lifting, reaching, or pressing after gym volume, cricket, swimming, or desk days that leave the cuff under-prepared. Night pain and side-sleeping intolerance are common.',
  },
  {
    title: 'Frozen shoulder',
    body: 'Progressive global stiffness, limited external rotation, and night pain. Stages matter. Aggressive stretching into a hot capsule often worsens symptoms.',
  },
  {
    title: 'Impingement pattern',
    body: 'A painful arc through mid-range elevation or catch when reaching overhead. Usually cuff weakness and scapular timing, not always a bone spur.',
  },
  {
    title: 'AC joint irritation',
    body: 'Pinpoint pain on top of the shoulder, worse with cross-body reach, press-ups, or carrying a bag on that side.',
  },
  {
    title: 'Desk posture & neck referral',
    body: 'Rounded upper back and cervical stiffness that sit in the shoulder blade without a true joint finding. Neck movement often reproduces the symptom.',
  },
  {
    title: 'Gym & overhead sport load',
    body: 'Bench press, push-ups, bowling, and badminton spike volume faster than the cuff can adapt. Pain after workout is a load problem until proven otherwise.',
  },
]
...
export default function PhysiotherapyShoulderPainMumbaiPage() {
  return (
    <main className="physio-page min-h-screen bg-white dark:bg-[#0A0A0A]">
      ...
      >
        <div className="relative flex flex-1 flex-col">
          <div className="absolute inset-0">
            <Image
              src="/images/service/Services_image/Physiotherapy_1.webp"
              alt="Physiotherapy for shoulder pain Mumbai, clinical care at R3BOOT Dadar"
              fill
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-center px-12 lg:px-16 xl:px-20 max-w-[54%]">
            ...
            >
              ...
              <span className="font-bold tracking-wider text-[11px] uppercase">Physiotherapy Dadar</span>
            </Link>

            <p className="text-[#A78BFA] text-[11px] font-black tracking-[0.25em] uppercase mb-4">
              Frozen Shoulder&nbsp;&nbsp;•&nbsp;&nbsp;Rotator Cuff&nbsp;&nbsp;•&nbsp;&nbsp;Clinical Care
            </p>

            <h1 className="text-5xl lg:text-6xl xl:text-[4.1rem] font-black text-white tracking-tight leading-[1.04] mb-4">
              Physiotherapy for
              <br />
              Shoulder Pain in <span className="text-[#A78BFA]">Mumbai</span>
            </h1>

            <p className="text-[16px] text-white/55 max-w-md leading-relaxed mb-7">
              Assessment-led care for cuff overload, frozen shoulder, impingement, and desk or gym pain at R3BOOT Dadar.
            </p>
      ...
      <section className="md:hidden pt-20 pb-0 bg-white dark:bg-[#0A0A0A]">
        <div className="container mx-auto px-5">
          ...
          <p className="text-base text-gray-500 dark:text-gray-400 leading-relaxed mb-6">
            Frozen shoulder, rotator cuff, impingement, desk and gym overload at R3BOOT Dadar.
          </p>
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12 sm:mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight mb-5 leading-tight">
              Shoulder pain is rarely one problem.{' '}
              <span className="text-[#513394] dark:text-[#8B5CF6]">We find the driver.</span>
            </h2>
            <p className="text-gray-500 dark:text-gray-400 text-base sm:text-lg leading-relaxed">
              Desk posture, gym pressing, and overhead sport can all look like the same sore shoulder until someone
              tests the cuff, capsule, AC joint, and neck. Stretching harder into a painful arc usually keeps it alive.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-5 max-w-7xl mx-auto">
            {shoulderPainCauses.map((item, idx) => (
              <div
                key={idx}
                className="relative p-5 sm:p-6 rounded-2xl bg-[#F8F9FA] dark:bg-white/[0.04] border border-gray-100 dark:border-white/[0.08] group hover:border-[#513394]/30 hover:shadow-lg dark:hover:shadow-none transition-all duration-300 overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  <div className="w-10 h-10 rounded-xl bg-[#513394]/10 dark:bg-[#8B5CF6]/20 flex items-center justify-center text-[#513394] dark:text-[#A78BFA] font-black mb-4 text-xs group-hover:bg-[#513394] group-hover:text-white transition-all">
                    {String(idx + 1).padStart(2, '0')}
                  </div>
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-14">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-base leading-relaxed">
              First session is 60 minutes. Wear clothing that lets us see the shoulder and upper back. Bring imaging if you have it.
            </p>
          </div>
            ...
            {[
              {
                icon: ClipboardCheck,
                number: '01',
                title: 'Full shoulder assessment',
                body: 'Painful arcs, cuff strength, scapular control, cervical screening, and a clear history of sleep, desk, and training load.',
              },
              {
                icon: Hand,
                number: '02',
                title: 'Hands-on treatment',
                body: 'Manual therapy, mobilisation, soft tissue release, and dry needling when indicated. Matched to the structure found in assessment.',
              },
              {
                icon: Target,
                number: '03',
                title: 'Load and home plan',
                body: 'What to pause, what to keep, and the first exercises that match your presentation. Desk and gym shoulders get different plans.',
              },
            ].map((step, i) => {
              ...
              return (
                <div
                  key={i}
                  className="relative flex flex-col p-5 sm:p-6 lg:p-7 rounded-2xl bg-white dark:bg-white/[0.04] border border-gray-100 dark:border-white/[0.08] group hover:border-[#513394]/30 hover:shadow-lg dark:hover:shadow-none transition-all duration-300 overflow-hidden"
                >
      ...
      {/* ─── METHODOLOGY ─── */}
      <section className="py-16 sm:py-24 lg:py-32 bg-white dark:bg-[#0A0A0A]">
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight mb-4 leading-tight">
              How we treat{' '}
              <span className="text-[#513394] dark:text-[#8B5CF6]">shoulder pain</span>
            </h2>
            <p className="text-gray-500 dark:text-gray-400 text-base leading-relaxed">
              Techniques are selected from your assessment findings, not a default shoulder protocol for every patient.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24 items-start max-w-7xl mx-auto">
            <div className="relative rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden aspect-[4/5] w-full shadow-2xl lg:sticky lg:top-28">
              <Image
                ...
                alt="Shoulder physiotherapy and manual therapy at R3BOOT Dadar Mumbai"
                fill
                className="object-cover"
              />
              ...
              <div className="absolute bottom-6 left-6 right-6 sm:bottom-8 sm:left-8 sm:right-8">
                <p className="text-white text-lg sm:text-xl font-black tracking-tight leading-tight mb-3">
                  Dr. Vaishali Rauniyar · Dry Needling & Aquatic Rehab
                </p>
                <div className="flex flex-col gap-2">
                  {['Cuff, capsule & neck assessed together', 'Dry needling available on-site'].map((point, i) => (
              ...
              {[
                {
                  ...
                  body: 'Glenohumeral and scapular mobilisation, soft tissue release, and joint work matched to cuff, capsule, or AC joint findings.',
                  light: '#513394',
                  dark: '#A78BFA',
                ...
                },
                {
                  icon: Zap,
                  title: 'Dry Needling',
                  body: 'Trigger-point needling for deep cuff and scapular spasm when muscle tension is driving secondary pain around the joint.',
                  light: '#B45309',
                  dark: '#FBBF24',
                ...
                },
                {
                  ...
                  body: 'Water-based loading when land elevation still spikes pain, including early post-surgical shoulder movement when cleared.',
                  light: '#0D9488',
                  dark: '#2DD4BF',
                ...
                },
                {
                  ...
                  body: 'Cuff and scapular capacity rebuilt to match your desk, gym, or sport demands. Not generic home exercise sheets.',
                  light: '#0369A1',
                  dark: '#38BDF8',
                ...
                {
                  icon: Scan,
                  title: 'Load & Movement Assessment',
                  body: 'Pressing volume, sleep position, and cervical contribution mapped so the plan removes what keeps restarting the pain.',
                  light: '#7C3AED',
                  dark: '#C4B5FD',
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`flex-1 min-w-0 ${isLast ? 'pb-0' : 'pb-5 sm:pb-6'}`}>
                      <div className="p-4 sm:p-6 rounded-2xl bg-[#F8F9FA] dark:bg-white/[0.04] border border-gray-100 dark:border-white/[0.06] hover:border-[var(--pbd)] dark:hover:border-[var(--pbdd)] transition-all duration-300">
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-gray-900 dark:text-white tracking-tight">
              Built for Your <span className="text-[#513394] dark:text-[#8B5CF6]">Shoulder Load</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6">
            {[
              {
                label: 'Desk & Tech Neck',
                tag: 'DESK //',
                description:
                  'Rounded upper back, trap spasm, and blade pain after long screen days. Often overlaps with neck referral.',
                image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1790225458/Desk_ak3rgp.webp',
                points: ['Neck referral', 'Trap spasm', 'Sleeping pain'],
              },
              {
                label: 'Gym & Pressing',
                tag: 'GYM //',
                description:
                  'Bench press, push-ups, and overhead volume that outruns cuff capacity. Painful arc and post-workout flare.',
                image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1790225459/Gym_cxocai.webp',
                points: ['Impingement', 'Bench pain', 'Load management'],
              },
              {
                label: 'Frozen Shoulder',
                tag: 'STIFFNESS //',
                description:
                  'Progressive loss of external rotation and night pain. Stage-matched care, not aggressive stretching into a hot capsule.',
                image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1790225458/Frozen_kra6cm.webp',
                points: ['Night pain', 'Limited rotation', 'Phased rehab'],
              },
              {
                label: 'Sport & Post-Surgery',
                tag: 'SPORT //',
                description:
                  'Cricket, badminton, swimming overload, and surgeon-cleared shoulder surgery rehab with clear milestones.',
                image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1790225467/Sport_gsxfwg.webp',
                points: ['Rotator cuff', 'Throwing load', 'Return to sport'],
              },
            ].map((item, idx) => (
              <div
                key={idx}
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8 max-w-5xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-gray-900 dark:text-white tracking-tight">
              Urgent care vs{' '}
              <span className="text-[#513394] dark:text-[#8B5CF6]">physiotherapy</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="p-6 sm:p-8 rounded-2xl bg-[#F8F9FA] dark:bg-white/[0.04] border border-gray-100 dark:border-white/[0.08]">
              <h3 className="text-lg font-black text-gray-900 dark:text-white mb-4">Seek urgent medical care if</h3>
              <ul className="space-y-3 text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                {[
                  'Chest pressure, shortness of breath, sweating, or jaw/arm heaviness with shoulder pain',
                  'Fever, systemic illness, or a deformed joint after a fall',
                  'Sudden inability to move the arm after trauma or dislocation',
                ].map((item, idx) => (
                  <li key={idx} className="flex items-start gap-3">
                    <span className="text-[#513394] dark:text-[#A78BFA] font-black shrink-0">!</span>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-[#F8F9FA] dark:bg-white/[0.04] border border-gray-100 dark:border-white/[0.08]">
              <h3 className="text-lg font-black text-gray-900 dark:text-white mb-4">Book physiotherapy when</h3>
              <ul className="space-y-3 text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                {[
                  'Pain lifting the arm, sleeping on that side, or reaching behind your back',
                  'Stiffness getting worse over weeks (possible frozen shoulder)',
                  'Gym, cricket, or swimming pain that returns after rest',
                  'Neck and shoulder pain together after long desk days',
                ].map((item, idx) => (
                  <li key={idx} className="flex items-start gap-3">
                    <span className="text-[#513394] dark:text-[#A78BFA] font-black shrink-0">→</span>
                    <span>{item}</span>
      ...
      {/* ─── FAQ ─── */}
      <FAQSection faqs={shoulderPainPhysiotherapyFaqs} />
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-white mb-6 sm:mb-8 tracking-tight leading-tight">
              Move better.{' '}
              <span className="text-white/50">Recover properly.</span>
            </h2>
            <p className="text-lg sm:text-xl text-white/70 mb-4 leading-relaxed font-medium max-w-3xl mx-auto">
              Clinical physiotherapy for shoulder pain at R3BOOT Dadar. Assessment first, then a plan for cuff,
              frozen shoulder, or gym overload.
            </p>
            <p className="text-white/40 mb-8 sm:mb-12 text-sm font-bold tracking-widest">
              203, Palai Plaza, Dadar East, Mumbai 400014
            </p>
      ...
      <ServiceSchema
        serviceName="Physiotherapy for Shoulder Pain in Mumbai"
        description="Clinical physiotherapy for shoulder pain in Mumbai at R3BOOT, Dadar East. Assessment, manual therapy, dry needling, and progressive rehabilitation for frozen shoulder, rotator cuff overload, shoulder impingement, AC joint pain, desk posture, and gym or sport overload. Led by Dr. Hiral Parikh (15+ years, BPT) and Dr. Vaishali Vijay Rauniyar (4+ years)."
        serviceUrl="https://www.r3boot.in/physiotherapy-for-shoulder-pain-mumbai"
      />
      <FAQSchema faqs={shoulderPainPhysiotherapyFaqs} />
      <BreadcrumbSchema
        items={[
          { name: 'Home', url: '/' },
          { name: 'Physiotherapy Dadar Mumbai', url: '/physiotherapy-dadar-mumbai' },
          { name: 'Physiotherapy for Shoulder Pain Mumbai', url: '/physiotherapy-for-shoulder-pain-mumbai' },
        ]}
      />
    </main>
  )
