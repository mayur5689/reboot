...
const DEFAULT_POINTS: PainPoint[] = [
  {
    title: 'Lower back pain that keeps returning',
    description:
      'Rest calms it down, then sitting or training brings it straight back. The underlying weakness was never addressed.',
  ...
  },
  {
    ...
    description:
      'Post-surgery or post-injury, your surgeon has signed off — but you still hesitate to load the area.',
    image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1785801666/image2_it1wlb.webp',
  },
  {
    title: 'Scoliosis or spinal asymmetry',
    description:
      'General fitness classes are not built around your specific curve or imbalance. You need exercise prescribed to your spine, not a generic sequence.',
  ...
  },
  {
    ...
    description:
      'You have done the mat classes. Improvement plateaued because no one assessed what is actually going wrong.',
    image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1785801667/image4_ehqwxv.webp',
  },
  {
    title: 'Desk-bound posture pain',
    description:
      'Stiffness and ache build through the afternoon. Stretching helps for an hour, then it is back.',
  ...
  },
  {
    ...
    description:
      'Runners, cricketers and swimmers need movement retraining specific to their sport, not just general core work.',
...
export function PainPointsSection({
  intro = 'If any of these feel like your week, a clinical assessment — not another class — is the missing step.',
  captionTitle = "Movement isn't one-size-fits-all.",
  captionBody = "It's prescribed to your diagnosis.",
          ...
          <div className="grid grid-cols-[42%_58%] gap-6 xl:gap-8">
            <div className="relative rounded-2xl overflow-hidden min-h-[560px] xl:min-h-[600px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 z-10 p-8">
                ...
                <p className="text-white/55 text-[15px] leading-relaxed mb-7">{points[active].description}</p>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-white font-bold text-[13px] leading-snug">{captionTitle}</p>
                    <p className="text-white/40 text-[13px]">{captionBody}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-4 p-5">
                ...
                <span
                  className={`flex-1 font-bold text-[16px] transition-colors ${isActive ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-white/55'}`}
                >
                  {pt.title}
                </span>
                <svg
