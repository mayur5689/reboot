              ...
              <div key={i} className="rounded-2xl border border-gray-100 dark:border-white/[0.08] bg-white dark:bg-[#0D0D13] overflow-hidden">
                ...
                <div className="px-5 py-4 border-b border-gray-100 dark:border-white/[0.06]">
                  <div className="flex items-center gap-2 mb-1.5">
                    ...
                    <span className="text-gray-400 dark:text-white/35 text-[10px] font-black tracking-widest uppercase">Spa Deep Tissue</span>
                  </div>
                  <p className="text-gray-500 dark:text-white/45 text-[14px] leading-snug pl-[22px]">{row.spa}</p>
                </div>
                ...
                <div className="px-5 py-4 bg-[#513394]/[0.05] dark:bg-[rgba(123,95,202,0.08)]">
                  <div className="flex items-center justify-between mb-1.5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[#513394] dark:text-[#A78BFA] text-[10px] font-black tracking-widest uppercase">R3BOOT Sports Massage</span>
                    </div>
