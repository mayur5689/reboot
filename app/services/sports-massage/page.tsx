...
export const metadata: Metadata = {
  ...
  description:
    'Clinical sports massage in Mumbai by certified specialists. Serving athletes in Dadar, Andheri, Thane & Bandra. Book at R3BOOT Recovery Center.',
  keywords: [
    'sports massage mumbai',
    'sports massage dadar',
    'deep tissue sports massage mumbai',
    'sports massage therapist mumbai',
    'sports recovery massage',
    'sports massage near me mumbai',
  ],
...
const sportsMassageTeam: TeamMember[] = [
  ...
  },
  {
    ...
    image:
      'https://res.cloudinary.com/dj7bot2uc/image/upload/v1771404920/aanya-rao-womens-sports-massage-specialist-mumbai_agreyq.avif',
...
const testimonials = [
  {
    ...
    quote:
      'Reboot team was wonderful. Navigated me through the entire contrast therapy experience with great insights. My body also feels lighter and better. Would definitely recommend this place for someone looking for good recovery.',
  },
  {
    ...
    <main className="ct-page min-h-screen bg-white dark:bg-[#0A0A0A] pb-24 md:pb-0">
      ...
      <section className="md:hidden pt-20 pb-0 bg-white dark:bg-[#0A0A0A]">
        <div className="container mx-auto px-5">
          ...
          <h1 className="text-[2rem] font-black text-gray-900 dark:text-white tracking-tight leading-[1.1] mb-3">
            Sports Massage in <span className="text-[#513394] dark:text-[#A78BFA]">Mumbai</span>
          </h1>
      ...
      <section id="session" className="py-16 sm:py-20 lg:py-28 bg-white dark:bg-[#0A0A0A]">
        <div className="container mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-5 lg:gap-6 max-w-7xl mx-auto">
            {[
              {
                icon: ClipboardCheck,
                number: '01',
            ...
            <div className="relative rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden aspect-[4/5] w-full shadow-2xl lg:sticky lg:top-28">
              ...
              <div className="absolute top-5 left-5 sm:top-6 sm:left-6 flex items-center gap-3 bg-white/95 backdrop-blur-sm rounded-2xl pl-3 pr-4 py-2.5 shadow-lg">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-bold text-[13px] leading-none">Clinical Bodywork</p>
                </div>
              </div>

              <div className="absolute bottom-6 left-6 right-6 sm:bottom-8 sm:left-8 sm:right-8">
                <p className="text-white text-lg sm:text-xl font-black tracking-tight leading-tight mb-3">
                  Akshay Anil Nalawde · Sports Massage Specialist
                </p>
                <div className="flex flex-col gap-2">
                  {['1000+ Athletes Treated', 'Cupping Level 1 & 2 Certified'].map((point, i) => (
                ...
                {[
                  {
                    ...
                    body: 'Used for chronic tightness and adhesions that build up over long training blocks. Targets specific layers of muscle tissue where restriction is limiting movement or causing compensatory patterns.',
                    light: '#513394',
                    dark: '#A78BFA',
                  ...
                  },
                  {
                    ...
                    body: 'Targets the fascial system surrounding muscles. Restrictions here cause postural issues and limit range of motion in ways deep tissue work alone cannot resolve.',
                    light: '#0D9488',
                    dark: '#2DD4BF',
                  ...
                  {
                    icon: CircleDot,
                    title: 'Cupping Therapy (Level 1 & 2)',
                    body: 'Used for fascia decompression, stubborn tight areas like the IT band and upper back, and improving blood flow to chronically compressed tissue.',
                    light: '#0369A1',
                    dark: '#38BDF8',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-7xl mx-auto">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight mb-4 leading-tight">
                ...
                <span className="text-[#513394] dark:text-[#8B5CF6]">With Vaishali Sonar</span>
              </h2>
              <p className="text-gray-500 dark:text-gray-400 text-base leading-relaxed mb-4">
                Most sports massage in Mumbai is not adapted for female physiology. Pressure, technique selection, and recovery protocols built around male athletes do not automatically translate to women.
              </p>
              <p className="text-gray-500 dark:text-gray-400 text-base leading-relaxed mb-10">
                At R3BOOT, female clients are treated by Vaishali Sonar — cupping certified Level 1 & 2 — with hands-on experience across competitive players and the general population.
              </p>
                ...
                {[
                  {
                    ...
                    body: 'Runners, cricketers, and gym athletes dealing with training load accumulation, muscle imbalances, and recovery between events.',
                  },
                  {
                    label: 'Women Who Train Seriously',
                    body: 'Lifting, functional fitness, or marathon prep puts the same load on your body as competitive sport. You do not need to be competing to need clinical recovery.',
                  },
                  {
                    label: 'Corporate Women Who Train After Work',
                    body: 'Desk load plus evening training creates thoracic stiffness, neck spasm, and hip flexor compression. Both get addressed in one session.',
                  },
                ].map((item, idx) => (
            ...
            {[
              {
                ...
                tag: 'RUNNING //',
                description:
                  'Calf tightness, plantar fascia pain, hamstring overload, and hip flexor stiffness — especially common in Mumbai runners who sit at a desk all day before evening runs.',
              ...
              },
              {
                ...
                tag: 'GYM //',
                description:
                  'Shoulder impingement, lower back tightness, rounded shoulders from tight pecs, and quad or hip flexor stiffness. Address compensation patterns before they become injuries.',
              ...
              },
              {
                ...
                tag: 'CRICKET //',
                description:
                  'Rotator cuff tightness from bowling and throwing, forearm and wrist overuse in batsmen, lower back asymmetry from one-sided movement demands.',
              ...
              },
              {
                ...
                tag: 'DESK + TRAINING //',
                description:
                  'Neck and upper trap spasm, thoracic stiffness, piriformis syndrome, and hip flexor tightness from prolonged desk work combined with hard training.',
      ...
      <section className="md:hidden py-10 bg-white dark:bg-[#0A0A0A]">
        <div className="px-5 mb-6">
          <span className="text-[11px] font-black tracking-[0.3em] text-[#513394] dark:text-[#A78BFA] uppercase block mb-2">Client Stories</span>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2.5">
                  <svg className="w-7 h-7 flex-shrink-0" viewBox="0 0 48 48">
                    ...
                    <path
                      fill="#34A853"
                      d="M6.3 14.7l7 5.1C15 16.1 19.1 13 24 13c3.1 0 5.9 1.1 8.1 2.9l6.4-6.4C34.6 4.1 29.6 2 24 2 16.3 2 9.6 7.3 6.3 14.7z"
                    />
                    <path
                      fill="#FBBC05"
                      d="M24 46c5.6 0 10.5-1.9 14.4-5l-6.7-5.5C29.6 37 26.9 38 24 38c-5.9 0-10.9-4-12.7-9.5l-7 5.4C7.5 41.8 15.2 46 24 46z"
                    />
                    <path
                      fill="#EA4335"
                      d="M44.5 20H24v8.5h11.8c-.8 2.4-2.3 4.4-4.3 5.8l6.7 5.5C42.1 36.4 45 30.7 45 24c0-1.3-.2-2.7-.5-4z"
                    />
                  </svg>
      ...
      <FAQSection faqs={sportsMassageFaqs} layout="grid" />
      ...
      <section className="md:hidden bg-white dark:bg-[#0A0A0A] pt-10 pb-28">
        <div className="px-4">
          ...
          >
            <div
              className="absolute top-0 right-0 w-48 h-48 rounded-full blur-[60px] opacity-30 pointer-events-none"
              style={{ background: '#7c3aed' }}
            />
            <div
              className="absolute bottom-0 left-0 w-40 h-40 rounded-full blur-[50px] opacity-20 pointer-events-none"
              style={{ background: '#1e0a5e' }}
            />
            <div className="relative">
              <h2 className="text-[26px] font-black text-white leading-tight tracking-tight mb-2">
                Stop Training on a Body <span className="text-[#A78BFA]">That Needs Maintenance</span>
              </h2>
      ...
      <section className="hidden md:block py-16 lg:py-20 bg-[#513394] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10 text-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tight mb-5 max-w-3xl mx-auto leading-tight">
            Stop Training on a Body That Needs <span className="text-white/45">Maintenance</span>
          </h2>
      ...
      <section className="py-16 bg-white dark:bg-[#0A0A0A]">
        <div className="container mx-auto px-6 lg:px-8 max-w-4xl">
          ...
          <div className="flex flex-wrap gap-6">
            <Link
              href="/blog/sports-massage-before-after-marathon"
              className="group p-6 bg-gray-50 dark:bg-white/5 rounded-[2rem] border border-gray-100 dark:border-white/10 hover:border-[#513394]/40 transition-all flex-1 min-w-[240px] max-w-md"
            >
            ...
            >
              ...
              <h3 className="font-bold text-gray-900 dark:text-white group-hover:text-[#513394] transition-colors">
                Sports Massage for Runners in Mumbai
              </h3>
