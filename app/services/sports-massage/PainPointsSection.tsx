...
const POINTS = [
  {
    title: 'Tightness that returns within days',
    description:
      'A spa massage felt good for 48 hours. By Wednesday the same calves, traps, or hip flexors are locked again — because nothing was assessed or targeted.',
    image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1785856300/image-7_bpblht.webp',
  },
  {
    title: 'Training load keeps stacking',
    description:
      'Volume is up, sleep is down, and your body has not had real recovery between sessions. Soft tissue is compensating until something gives.',
    image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1785856299/imag_4_v2_hywdwp.webp',
  },
  {
    title: 'Desk all day, train at night',
    description:
      'Eight hours of sitting, then a hard evening session. Neck, thoracic spine, and hip flexors take the hit — then you load them under fatigue.',
  ...
  },
  {
    ...
    description:
      'Calf, IT band, shoulder, or lower back that flares whenever volume goes up. Compensations are driving it — not bad luck.',
    image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1785856300/image-6_z4cmvp.webp',
  },
  {
    title: 'Race or match coming up',
    description:
      'You need tissue ready for peak demand, not a generic relaxation session. Pre-event and post-event work should match your training phase.',
    image: 'https://res.cloudinary.com/dj7bot2uc/image/upload/v1785856298/image_2_V2_idovyw.webp',
  },
  {
    title: 'Spa deep tissue did not fix it',
    description:
      'Pressure preference is not a treatment plan. Without movement assessment, trigger-point work, and activation, you get temporary relief — not recovery.',
    ...
    <section id="signs" className="bg-[#F8F9FA] dark:bg-[#080808] py-16 sm:py-20 lg:py-24">
      <div className="text-center mb-10 sm:mb-12 px-5">
        ...
        <p className="text-gray-500 dark:text-white/40 text-base sm:text-lg mt-4 max-w-2xl mx-auto leading-relaxed">
          If any of these feel like your week, clinical sports massage — not another spa booking — is the missing step.
        </p>
      </div>
            ...
            <div className="relative rounded-2xl overflow-hidden min-h-[560px] xl:min-h-[600px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 z-10 p-8">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-white font-bold text-[13px] leading-snug">Recovery starts with assessment.</p>
                    <p className="text-white/40 text-[13px]">Not a preference form.</p>
                  </div>
                </div>
              </div>
            </div>
