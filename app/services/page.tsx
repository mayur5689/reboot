...
export const metadata: Metadata = {
  ...
  description: 'Physiotherapy, contrast therapy, compression therapy, aqua therapy, sports massage & sports psychology in Dadar, Mumbai. Book your session at R3BOOT, open 7 days.',
