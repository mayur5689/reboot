  ...
  return (
    <main className="psych-page min-h-screen bg-white dark:bg-[#0A0A0A]">
      ...
      <section className="hidden md:flex relative flex-col bg-black overflow-hidden" style={{ minHeight: '92vh' }}>
        ...
        {/* Compact glass trust bar — in flow so CTA gap stays clear */}
        <div className="relative z-20 mt-10 mb-7 lg:mb-8 px-12 lg:px-16 xl:px-20">
          <div
          ...
          >
            ...
            <div className="grid grid-cols-4">
              {/* 1 — Google Reviews */}
              <div className="relative flex flex-col items-center text-center px-3 py-4 lg:py-4.5">
                <div
                  className="w-9 h-9 rounded-full flex items-center justify-center mb-2.5 border border-white/[0.1]"
                  style={{
                    background: 'radial-gradient(circle at 50% 40%, rgba(255,255,255,0.08) 0%, rgba(0,0,0,0.45) 70%)',
                    boxShadow: '0 0 14px rgba(66,133,244,0.22), inset 0 1px 0 rgba(255,255,255,0.08)',
                  }}
                >
                  <svg className="w-4.5 h-4.5 w-[18px] h-[18px]" viewBox="0 0 48 48" aria-hidden>
                ...
                <p className="text-white text-[22px] font-black leading-none tracking-tight">5.0</p>
                ...
                <p className="text-white text-[12px] font-bold leading-none mb-1">Google Reviews</p>
                <p className="text-white/40 text-[11px] leading-snug">500+ Happy Clients</p>
              </div>

              {/* 2 — Session length */}
              <div className="relative flex flex-col items-center text-center px-3 py-4 lg:py-4.5">
                <div className="absolute left-0 top-[20%] bottom-[20%] w-px bg-white/[0.12]" />
                <div
                  className="w-9 h-9 rounded-full flex items-center justify-center mb-2.5 border border-white/[0.1] text-[#A78BFA]"
                  style={{
                    background: 'radial-gradient(circle at 50% 40%, rgba(167,139,250,0.16) 0%, rgba(0,0,0,0.45) 70%)',
                    boxShadow: '0 0 16px rgba(167,139,250,0.28), inset 0 1px 0 rgba(255,255,255,0.08)',
                  }}
                >
                  <svg className="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6} aria-hidden>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <p className="text-white text-[22px] font-black leading-none tracking-tight mb-1.5">50 Min</p>
                <p className="text-white text-[12px] font-bold leading-none mb-1">Focused Sessions</p>
                <p className="text-white/40 text-[11px] leading-snug">Quality time. Real results.</p>
              </div>
              ...
              <div className="relative flex flex-col items-center text-center px-3 py-4 lg:py-4.5">
                ...
                <p className="text-white text-[20px] font-black leading-none tracking-tight mb-1.5">Specialist-Led</p>
                <p className="text-white text-[12px] font-bold leading-none mb-1">Mental Performance</p>
                <p className="text-white/40 text-[11px] leading-snug">Expert care. Measurable impact.</p>
              </div>
              ...
              <div className="relative flex flex-col items-center text-center px-3 py-4 lg:py-4.5">
                ...
                <p className="text-white text-[20px] font-black leading-none tracking-tight mb-1.5">Confidential</p>
                <p className="text-white text-[12px] font-bold leading-none mb-1">Private Sessions</p>
                <p className="text-white/40 text-[11px] leading-snug">Your privacy. Our priority.</p>
              </div>
            </div>
          </div>
        </div>
