...
import { MessageCircle, ClipboardList, Target, Activity, Clock, Trophy, Check, Brain } from 'lucide-react'

const ROWS = [
  {
    icon: ClipboardList,
    label: 'Starting point',
    generic: 'Open-ended talk without a performance goal',
    clinical: 'One intake, clear direction: performance, counselling, or both',
  },
  {
    icon: Target,
    label: 'What you practise',
    generic: 'Techniques discussed, rarely rehearsed under load',
    clinical: 'Visualisation, focus cues, self-talk, practised for training the same week',
  },
  {
    icon: Activity,
    label: 'With physical rehab',
    generic: 'Mental and physical care sit on separate tracks',
    clinical: 'Coordinated with physiotherapy in the same centre when needed',
  },
  {
    icon: Clock,
    label: 'Session format',
    generic: 'Open-ended traditional therapy',
    clinical: '50 minutes, private, structured, time-bound',
  },
  {
    icon: MessageCircle,
    label: 'Scope',
    generic: 'General emotional support alone',
    clinical: 'Performance skills and counselling as one integrated service',
  },
  {
    icon: Trophy,
    label: 'Best for',
    generic: 'Anyone seeking talk support',
    clinical: 'Athletes, high performers, and working professionals under pressure',
  },
]
      ...
      <div className="container mx-auto px-5 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight leading-[1.1] mb-5">
            Mental performance is more than{' '}
            <span className="text-[#7B5FCA]">open-ended talk.</span>
          </h2>
          <div className="w-10 h-[2px] bg-[#7B5FCA] mx-auto mb-5" />
          <p className="text-gray-500 dark:text-white/45 text-base leading-relaxed">
            One offering: performance skills for edge, emotional support for stability. For athletes and working professionals under pressure.
          </p>
        </div>
              ...
              <div key={i} className="rounded-2xl border border-gray-100 dark:border-white/[0.08] bg-white dark:bg-[#0D0D13] overflow-hidden">
                ...
                <div className="px-5 py-4 border-b border-gray-100 dark:border-white/[0.06]">
                  <div className="flex items-center gap-2 mb-1.5">
                    <MessageCircle className="w-3.5 h-3.5 text-gray-400 dark:text-white/35" strokeWidth={2} />
                    <span className="text-gray-400 dark:text-white/35 text-[10px] font-black tracking-widest uppercase">Generic Talk Support</span>
                  </div>
                ...
                <div className="px-5 py-4 bg-[#513394]/[0.05] dark:bg-[rgba(123,95,202,0.08)]">
                  <div className="flex items-center justify-between mb-1.5">
                    <div className="flex items-center gap-2">
                      <Brain className="w-3.5 h-3.5 text-[#513394] dark:text-[#A78BFA]" strokeWidth={2} />
                      <span className="text-[#513394] dark:text-[#A78BFA] text-[10px] font-black tracking-widest uppercase">R3BOOT Mental Performance</span>
                    </div>
          ...
          <div className="grid" style={{ gridTemplateColumns: COLS }}>
            ...
            <div style={{ gridColumn: 3, gridRow: HEADER_ROW }} className="relative flex items-center justify-center gap-3 h-full px-4 sm:px-7 py-6 sm:py-7">
              <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full border-[1.5px] border-[#A78BFA] bg-[rgba(167,139,250,0.10)] flex items-center justify-center shrink-0">
                <Brain className="w-[18px] h-[18px] text-[#513394] dark:text-[#A78BFA]" strokeWidth={2} />
              </div>
              <span className="text-gray-900 dark:text-white font-black text-[12px] sm:text-[14px] tracking-wide uppercase whitespace-nowrap">
                R3BOOT Mental Performance
              </span>
            </div>
