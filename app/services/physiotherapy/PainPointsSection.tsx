...
const POINTS = [
  ...
  {
    title: 'You have tried other clinics already',
    description: 'Session-by-session symptom relief. No clear plan, no timeline, and the same problem six months later.',
  ...
  {
    title: 'Injury mid-season, no structured path back',
    description: 'A strain or sprain that never got a proper assessment. You need milestones, not "take it easy for two weeks."',
            ...
            <div className="relative rounded-2xl overflow-hidden min-h-[560px] xl:min-h-[600px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 z-10 p-8">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-white font-bold text-[13px] leading-snug">Treatment starts with why it hurts.</p>
                    <p className="text-white/40 text-[13px]">Not just where it hurts.</p>
                  </div>
                </div>
              </div>
            </div>
