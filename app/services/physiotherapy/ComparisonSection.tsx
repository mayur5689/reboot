              ...
              <div key={i} className="rounded-2xl border border-white/[0.08] bg-[#0D0D13] overflow-hidden">
                ...
                <div className="px-5 py-4 border-b border-white/[0.06]">
                  <div className="flex items-center gap-2 mb-1.5">
                    ...
                    <span className="text-white/35 text-[10px] font-black tracking-widest uppercase">Standard Physio Clinic</span>
                  </div>
                  <p className="text-white/45 text-[14px] leading-snug pl-[22px]">{row.standard}</p>
                </div>
                ...
                <div className="px-5 py-4" style={{ background: 'rgba(123,95,202,0.08)' }}>
                  <div className="flex items-center justify-between mb-1.5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[#A78BFA] text-[10px] font-black tracking-widest uppercase">R3BOOT Physiotherapy</span>
                    </div>
